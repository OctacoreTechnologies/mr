    ...
    <table style="width: 100%; font-size: 15px; font-family: 'Poppins'; line-height: 9px;">
      <tr>
        ...
        <td style="width: 33.33%; text-align: left;">
          <div style="font-weight: bold; font-size: 16px; border-bottom: 1px solid black; display: inline-block; padding-bottom: 3px;">
            Submitted By
          </div>
        ...
        <td style="width: 33.33%; text-align: center;">
          <div style="width: 50%; font-weight: bold; border-bottom: 1px solid black; display: inline-block; padding-bottom: 3px; font-size: 16px;">
            Contact No.
          </div>
