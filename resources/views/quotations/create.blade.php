                ...
                $second=trim($parts[1]);
                  ...
                  $first=$second=trim($machineName);
                    ...
                    $selects = [
                        ...
                        ['label' => 'Selec '.$second.' Motor Requirement', 'name' => 'motor_requirement2', 'name1' => 'motor_requirement2_id', 'options' => $motorRequirements2, 'key' => 'motor_requirement'],
        ...
        <form action="{{ route('quotation.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <x-adminlte-input type="text" name="client" label="Client" value="{{ $customer->company_name }}" readonly/>
