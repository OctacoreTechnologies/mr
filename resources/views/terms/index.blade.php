    ...
    <div class="card shadow border-0">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <x-adminlte-datatable id="terms-table" :heads="$heads" striped hoverable bordered compressed responsive>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm">
                                    @can('terms_edit')   
                                     <a href="{{ route('term-conditions.edit', $term->id) }}" class="btn btn-outline-primary"
                                        title="Edit">
                                    ...
                                    {{--
                                    <form action="{{ route('term-conditions.destroy', $term->id) }}" method="POST"
