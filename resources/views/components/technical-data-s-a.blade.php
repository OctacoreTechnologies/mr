    ...
    <div class="techincal-data parameter-table techincal-specification">
        ...
        <table class="parameter-table"
            ...
            @if (isset($quotation->material_to_process_id))
                <tr>
                    ...
                    <td class="value-cell"><span
                            style="position: relative;left:4px;">{{ $quotation->materialToProcess->material_to_process ?? '' }}</span>
                    </td>
                </tr>
            @endif
            <tr>
            ...
            @if (isset($quotation->mixing_tool_id))
                <tr>
                    ...
                    <td class="value-cell"><span
                            style="position: relative;left:4px;">{!! $quotation->mixingTool->mixing_tool ?? '' !!}</span>
                    </td>
                </tr>
            @endif
        </table>
        ...
        <table class="parameter-table"
            ...
            <tr>
                ...
                <td class="value-cell"><span style="position: relative;left:4px;">Complete Electrical Control Panel
                        comprising of Thermocouple Wire, Digital Temperature Indicator
    ...
    <div class="techincal-data parameter-table techincal-specification">
        ...
        <table class="parameter-table"
            ...
            <tr>
                <td style="padding: 8px; vertical-align: top; white-space: nowrap;">• &nbsp; Product</td>
                <td class="value-cell"><span
                        style="position: relative;left:4px;">{{ $quotation->application->name ?? '' }} Compound</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="value-cell"><span style="position: relative;left:4px;">{{ $capacity - ($capacity * 3) / 10 }}
                        Ltr</span> </td>
            </tr>
            <tr>
        ...
        <table class="parameter-table"
            ...
            <tr>
                <td style="padding: 8px; vertical-align: top; white-space: nowrap; width: 55%;">• &nbsp; Motor
                    Requirement</td>
                <td class="value-cell"><span style="position: relative;left:4px;">{{
                        $quotation->motorRequirement2->motor_requirement ?? '' }}</span></td>
            </tr>
            <tr>
                <td style="padding: 8px; vertical-align: top; white-space: nowrap;">• &nbsp; Voltage</td>
                <td class="value-cell"><span style="position: relative;left:4px;">415 V</span></td>
        ...
        <div class="technical-data-sub-head"
            ...
            <tr>
                <td style="padding: 8px; vertical-align: top; white-space: nowrap; width: 55%;">• &nbsp; Motor
                    Requirement</td>
                <td class="value-cell"><span
                        style="position: relative;left:4px;">{{ $quotation->motorRequirement2->motor_requirement ?? '' }}</span>
                </td>
            </tr>
            <tr>
                <td style="padding: 8px; vertical-align: top; white-space: nowrap;">• &nbsp; Voltage</td>
            ...
            <tr>
                <td style="padding: 8px; vertical-align: top; white-space: nowrap; width: 55%;">• &nbsp; Control Panel
                </td>
                <td class="value-cell"><span style="position: relative;left:4px;">Complete Electrical Control Panel
                        comprising of Thermocouple Wire, Digital Temperature Indicator
                        with Ammeter & Voltmeter, Limit Switch & MCCB provided for safety precaution.</span>
