<div style="position: relative; font-size: 16px; padding: 170px 0px 0 10px; line-height: 1.2;">
  ...
  <div style="padding:20px 0 0 0 0; padding-left: 0;">
    ...
    <div style="font-size: 25px; margin-top: 5px; text-align: center; width: 100%;">
       Proposal for {{ $quotation->machine->name ?? '' }} Model {{ $quotation->modele->name ?? '' }}
    </div>
...
<div class='img'>
 ...
 <img src="{{asset('storage/' . $quotation->machine->image_url) ?? 'mixture.png'}}" class="main-image " style="z-index: 0;" > 
  </div>
</div>
