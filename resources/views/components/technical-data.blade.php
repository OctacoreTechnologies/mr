        ...
        <!-- DESIGN PARAMETER -->
         ...
         <table class="parameter-table"
            ...
            @if(isset($quotation->water_pressure))
                <tr><td style="padding: 8px; vertical-align: top; white-space: nowrap;">• &nbsp; Water Pressure</td><td class="value-cell"> <span style="position: relative;left:4px;">{{ $quotation->water_pressure }} Bar</span></td></tr>
            @endif

            @if(isset($quotation->operating_pressure))
                <tr><td style="padding: 8px; vertical-align: top; white-space: nowrap;">• &nbsp; Operating Pressure</td><td class="value-cell"> <span style="position: relative;left:4px;">{{ $quotation->operating_pressure }} Bar</span></td></tr>
            @endif
