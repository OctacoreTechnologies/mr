...
@section('title', 'Material To Process')

@section('content_header')
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        <h1 class="mb-2 mb-md-0">Material To Process</h1>
        <div class="d-flex flex-wrap gap-2">
            {{-- Primary Add Button --}}
            <x-adminlte-button label="Add Material To Process" theme="success" icon="fas fa-plus" data-toggle="modal" data-target="#modalMin"/>
...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="card-title">Material To Process</h3>
        ...
        <x-adminlte-datatable id="table1" :heads="$heads" striped hoverable bordered compressed>
            @foreach ($mateiralToProcess as $mateiralToProces)
                <tr>
                    ...
                    <td>
                        <nobr>
                            <a href="{{ route('material-to-process.edit', $mateiralToProces->id) }}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                                <i class="fa fa-lg fa-fw fa-pen"></i>
                            </a>
                            <form action="{{ route('material-to-process.destroy', $mateiralToProces->id) }}" method="POST" class="d-inline-block">
                                @csrf
                                @method('DELETE')
