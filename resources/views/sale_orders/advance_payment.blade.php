            ...
            <tr class="bordered">
                ...
                @php
                    ...
                    if ($dicountType == 'percentage') {
                        ...
                        $unitPrice = $unitPrice - $saleOrder->discount_amount/count($saleOrder->quotation->items) ?: 1;
                    }
                ...
                @foreach ($saleOrder->quotation->items as $item)
                    @php
                        ...
                        if ($dicountType == 'percentage') {
                            ...
                            $itemUnitPrice = $itemUnitPrice - $saleOrder->discount_amount/count($saleOrder->quotation->items) ?: 1;
                        }
