...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="mb-0 text-primary font-weight-bold">Edit Sales Order</h1>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <x-adminlte-input value="" label="Work Order No" name="purchase_order_no" value="{{ $saleOrder->work_order_no }}" readonly />
                </div>
                <div class="col-md-3 mb-3">
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>11. Total GST Price</th>
                            <td>{{format_indian_number($taxAmount)}}</td>
                        </tr>
                        <tr>
                            <th>12. Total Final Price</th>
                            <td>{{format_indian_number($grandTotal + $saleOrder->transporation_charge) }}</td>
                        </tr>
                        <tr>
                            <th>13. Total Advance</th>
                            <td>{{format_indian_number($saleOrder->advanace_payment ?? 'N/A') }}</td>
                        </tr>
                        <tr>
                            <th>14. Balance Payment</th>
                            <td>{{format_indian_number($grandTotal - $saleOrder->total_advanace_amount ?? 'N/A') }}</td>
                        </tr>
                        <tr>
                            <th>15. Transportation</th>
