            ...
            <div class="row">
                ...
                <div class="container-fluid">
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-right">Work Order No.</label>
                        <div class="col-md-6">
                            <x-adminlte-input type="text" name="work_order" value="{{ $orderAcceptanceLetter->saleOrder->work_order_no ?? '' }}" readonly />
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-right">Machine</label>
                        <div class="col-md-6">
                            <x-adminlte-input type="text" name="machine" value="{{ $quotation->machine->name ?? '' }}" />
                        </div>
                    </div>

                    {{-- Material To Be Process (Commented) --}}
                    {{--
    <div class="form-group row">
        <label class="col-md-4 col-form-label text-right">Material To Be Process</label>
        <div class="col-md-6">
            <x-adminlte-input type="text" name="application" value="{{ $quotation->application->name ?? '' }}" />
                </div>
            </div>
            --}}

            <div class="form-group row">
                <label class="col-md-4 col-form-label text-right">Model</label>
                <div class="col-md-6">
                    <x-adminlte-select name="model">
                      
                            @foreach ($modeles as $model)
                                <option value="{{ $model->production??'' }}" {{ $quotation->model_id==$model->id?'selected':'' }}>
        ...
        <div class="form-group row align-items-center col-12">
            <label for="{{ $key . '_id' }}" class="col-md-4 col-form-label text-right">
                {{ ucwords(str_replace('_', ' ', $key)) }}
            </label>
            <div class="col-md-6">
                <select name="{{ $key }}" id="{{ $key . '_id' }}" class="form-control select2" style="width: 100%;">
...
document.addEventListener('DOMContentLoaded', function () {
    // Select all <select> elements you want to clean up
    ...
    selectElements.forEach(select => {
        ...
        // Reapply selected value to make sure it's preserved
