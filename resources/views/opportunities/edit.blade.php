        ...
        <div class="card-body">
            <form action="{{ route('opportunity.update', $opportunity->id) }}" method="POST">
                ...
                <div class="row">
                    {{-- Lead --}}
                    <div class="col-md-6">
                        <x-adminlte-select name="lead_id" id="lead_id" label="Lead" fgroup-class="mb-3" class="js-example-basic-single">
                    ...
                    {{-- Opportunity Name --}}
                    <div class="col-md-6">
                        <x-adminlte-input name="name" label="Opportunity Name" value="{{ old('name', $opportunity->name) }}" placeholder="Enter Opportunity Name" fgroup-class="mb-3" />
                        @error('name')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    {{-- Expected Close Date --}}
                    <div class="col-md-6">
                        <x-adminlte-input name="expected_close_date" type="date" label="Expected Close Date" value="{{ old('expected_close_date', $opportunity->expected_close_date) }}" fgroup-class="mb-3" />
                    ...
                    {{-- Probability --}}
                    <div class="col-md-6">
                        <x-adminlte-input name="probability" type="number" min="0" max="100" label="Probability (%)" value="{{ old('probability', $opportunity->probability) }}" fgroup-class="mb-3" />
                        @error('probability')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    {{-- Close Date --}}
                    <div class="col-md-6">
                        <x-adminlte-input name="close_date" type="date" label="Close Date" value="{{ old('close_date', $opportunity->close_date) }}" fgroup-class="mb-3" />
                        @error('close_date')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        <x-adminlte-select name="opportunity_type" label="Opportunity Type" fgroup-class="mb-3">
                            <option value="new_business" {{ old('opportunity_type', $opportunity->opportunity_type) == 'new_business' ? 'selected' : '' }}>New Business</option>
                    ...
                    {{-- Notes --}}
                    <div class="col-md-6">
                        <x-adminlte-textarea label="Remark 1" name="remark1">{{ old('remark1',$opportunity->remark1) }}</x-admintlte-textarea>
                    </div>
                    <div class="col-md-6">
                        <x-adminlte-textarea label="Remark 2" name="remark2">{{ old('remark2',$opportunity->remark1) }}</x-admintlte-textarea>
                    </div>
