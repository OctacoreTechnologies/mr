...
<div style="display:flex;align-items:center;justify-content:space-between;padding:0.5rem 0">
    <h1 style="font-size:20px;font-weight:500;display:flex;align-items:center;gap:10px;margin:0">
        <i class="fas fa-edit" style="color:#6b7280"></i> Edit Customer
    </h1>
    <a href="{{ url()->previous() }}"
...
<form method="POST" action="{{ route('customer.update', $customer->id) }}" enctype="multipart/form-data" id="customerForm">
    @csrf
    @method('PUT')
        ...
        <div class="crm-section-body">
            <div class="crm-form-grid crm-form-grid-3">
                ...
                <div class="crm-field-wrap">
                    ...
                    <input type="text" name="city" value="{{ old('city', $customer->city) }}" class="crm-input" placeholder="Enter city">
                </div>
                <div class="crm-field-wrap">
                    <label class="crm-field-label">Area</label>
                    <input type="text" name="area" value="{{ old('area', $customer->area) }}" class="crm-input" placeholder="Enter area">
                </div>
                <div class="crm-field-wrap">
                    <label class="crm-field-label">Pincode</label>
                    <input type="text" name="pincode" value="{{ old('pincode', $customer->pincode) }}" class="crm-input" placeholder="Enter pincode">
                    @error('pincode')
        ...
        <div class="crm-section-body">
            <div class="crm-form-grid crm-form-grid-3">
                ...
                <div class="crm-field-wrap">
                    ...
                    <input type="text" name="company_website" value="{{ old('company_website', $customer->company_website) }}"
            ...
            <div class="crm-form-grid crm-form-grid-2">
                <div class="crm-field-wrap">
                    ...
                    <textarea name="address_line_1" id="billTo" class="crm-textarea" placeholder="Enter billing address">{{ old('address_line_1', $customer->address_line_1) }}</textarea>
                </div>
                <div class="crm-field-wrap">
                    ...
                    <textarea name="address_line_2" id="shipTo" class="crm-textarea" placeholder="Enter shipping address">{{ old('address_line_2', $customer->address_line_2) }}</textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="crm-section-body">
            <div class="crm-form-grid crm-form-grid-3">
                ...
                {{-- <div class="crm-field-wrap">
                    ...
                    <input type="text" name="lead_source" value="{{ old('lead_source', $customer->lead_source) }}" class="crm-input" placeholder="Lead source">
                </div> --}}
                <div class="crm-field-wrap">
                    <label class="crm-field-label">Remark 1</label>
                    <textarea name="remark" class="crm-textarea" placeholder="Enter remarks">{{ old('remark', $customer->remark) }}</textarea>
                </div>
                <div class="crm-field-wrap">
                    <label class="crm-field-label">Remark 2</label>
                    <textarea name="remark2" class="crm-textarea" placeholder="Enter additional remarks">{{ old('remark2', $customer->remark2) }}</textarea>
                </div>
                <div class="crm-field-wrap">
                    <label class="crm-field-label">Lead source remark</label>
                    <textarea name="lead_source_remark" class="crm-textarea" placeholder="Enter lead source remark">{{ old('lead_source_remark', $customer->lead_source_remark) }}</textarea>
                </div>
            </div>
        </div>
    </div>
