            ...
            <div class="row p-4">
                ...
                <div class="col-md-6">
                    <x-adminlte-select name="location_type" label="Location Type" fgroup-class="mb-3">
                        ...
                        <option value="international" {{ $customer->location_type == 'international' ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    <x-adminlte-select name="country" id="country" label="Select Country">
                        @foreach ($countries as $country)
                            <option value="{{ strtolower($country->country) }}" {{ strtolower($country->country) == $customer->country ? 'selected' : '' }}>{{$country->country}}
                            </option>
                        @endforeach
                    </x-adminlte-select>
                ...
                <div class="col-md-6" id="stateGroup">
                    <x-adminlte-select name="state" label="State" fgroup-class="mb-3">
                        @foreach ($states as $state)
                            <option value="{{ $state->name }}" {{ $state->name == $customer->state ? 'selected' : '' }}>
                                {{ $state->name }}</option>
                        @endforeach
                    </x-adminlte-select>
                </div>
                ...
                <!-- Contact No -->
                <div class="col-md-6">
                    <x-adminlte-input name="contact_no" value="{{ $customer->contact_no ?? '' }}" label="Contact No"
                    ...
                    @for ($i = 1; $i <= 6; $i++)
                        <div class="col-md-6">
                            <x-adminlte-input name="contact_person_{{ $i }}_name"
                                ...
                                label="Contact Person {{ $i }} Name" placeholder="Enter Contact Person 2 Name"
                        ...
                        <div class="col-md-6">
                            <x-adminlte-input name="contact_person_{{ $i }}_designation"
                                ...
                                label="Contact Person {{ $i }} Designation" placeholder="Enter Contact Person 2 Designation"
                                fgroup-class="mb-3" disable-feedback />
                        </div>
                        ...
                        <div class="col-md-6">
                            <x-adminlte-input name="contact_person_{{ $i }}_contact"
                                ...
                                label="Contact Person {{ $i }} Contact" placeholder="Enter Contact Person 2 Contact"
                                fgroup-class="mb-3" disable-feedback />
                        </div>
                        <div class="col-md-6">
                            <x-adminlte-input type="email" name="contact_person_{{ $i }}_eamil"
                                value="{{ $customer->{'contact_person_' . $i . '_email'} ?? '' }}"
                                label="Contact Person {{ $i }} email" placeholder="Enter Contact Person 2 Email"
                                fgroup-class="mb-3" disable-feedback />
                        </div>
                    @endfor
                </div>
