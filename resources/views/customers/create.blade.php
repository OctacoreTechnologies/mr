            ...
            <form method="POST" action="{{ route('customer.store') }}">
                ...
                <div class="row">
                 ...
                 <div class="col-md-4">
                    ...
                    <!-- City -->
                    <div class="col-md-4">
                        <x-adminlte-input name="city" value="{{ old('city') }}" label="City" placeholder="Enter City" fgroup-class="mb-3" disable-feedback />
                    </div>

                    <!-- Area -->
                    <div class="col-md-4">
                        <x-adminlte-input name="area" value="{{ old('area') }}" label="Area" placeholder="Enter Area" fgroup-class="mb-3" disable-feedback />
                    </div>

                    <!-- Pincode -->
                    <div class="col-md-4">
                        <x-adminlte-input name="pincode" value="{{ old('pincode') }}" label="Pincode" placeholder="Enter Pincode" fgroup-class="mb-3" disable-feedback />
                    </div>

                    <!-- Company Name -->
                    <div class="col-md-4">
                        <x-adminlte-input name="company_name" value="{{ old('company_name') }}" label="Company Name" placeholder="Enter Company Name" fgroup-class="mb-3" disable-feedback />
                    </div>

                    <!-- Contact No -->
                    <div class="col-md-4">
                        <x-adminlte-input name="contact_no" value="{{ old('contact_no') }}" label="Contact No" placeholder="Enter Contact No" fgroup-class="mb-3" disable-feedback />
                    </div>

                    <!-- Address Lines -->
                    <div class="col-md-4">
                        <x-adminlte-textarea name="address_line_1"  label="Address Line 1 (Bill To)" placeholder="Enter Address Line 1" fgroup-class="mb-3">{{ old('address_line_1') }}</x-adminlte-textarea>
                    </div>
                    <div class="col-md-4">
                        <x-adminlte-textarea name="address_line_2" label="Address Line 2 (Ship To)" placeholder="Enter Address Line 2" fgroup-class="mb-3">{{ old('address_line_2') }}</x-adminlte-textarea>
                    </div>
                    ...
                    <div class="row col-12" id="contact_person_fields">
                      <div class="col-md-4">
                          <x-adminlte-input name="contact_person_1_name" value="{{ old('contact_person_1_name') }}" label="Contact Person 1 Name" placeholder="Enter Name" fgroup-class="mb-3" />
                      </div>
                      <div class="col-md-4">
                          <x-adminlte-input name="contact_person_1_designation" value="{{ old('contact_person_1_designation') }}" label="Contact Person 1 Designation" placeholder="Enter Designation" fgroup-class="mb-3" />
                      </div>
                     <div class="col-md-4">
                          <x-adminlte-input name="contact_person_1_contact" value="{{ old('contact_person_1_contact') }}" label="Contact Person 1 Contact" placeholder="Enter contact" fgroup-class="mb-3" />
                      </div>
                      <div class="col-md-4">
                          <x-adminlte-input name="contact_person_1_email" value="{{ old('contact_person_1_email') }}" label="Contact Person 1 Email" placeholder="Enter Email" fgroup-class="mb-3" />
                      </div>
                    </div>  

                    <!-- GST -->
                    <div class="col-md-4">
                        <x-adminlte-input name="gst" value="{{ old('gst') }}" label="GST Number" placeholder="Enter GST Number" fgroup-class="mb-3" />
                    </div>
                    <!-- Status and Followed By -->
                    <div class="col-md-4">
                        <x-adminlte-select name="status" label="Status" fgroup-class="mb-3">
                            <option value="quoated">Quoted</option>
                            ...
                            <option value="existing">Existing</option>
                                        ...
                                        <!-- Remarks -->
                    <div class="col-md-4">
                        <x-adminlte-textarea name="remark" label="Remark1" placeholder="Enter any remarks" fgroup-class="mb-3">{{ old('remark') }}</x-adminlte-textarea>
                    </div>
                    <div class="col-md-4">
                        <x-adminlte-textarea name="remark2" label="Remark2" placeholder="Enter any remarks" fgroup-class="mb-3">{{ old('remark2') }}</x-adminlte-textarea>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12 text-center mt-3">
                        ...
                        <x-adminlte-button label="Cancel" type="button" theme="danger" class="mx-2" onclick="window.history.back();" />
                    </div>
                </div>
            </form>
        </div>
