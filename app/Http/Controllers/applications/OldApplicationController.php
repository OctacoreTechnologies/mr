...
class OldApplicationController extends Controller
{
  /**
...
public function update(StoreApplicationRequest $request, string $id)
{
  ...
  protected function relationFields(): array
  {
    return [
      ...
      'make_motor2'             =>     [MakeMotor::class, 'name'],
      ...
      'electrical_control2'     =>     [ElelctricalControl::class, 'electrical_control'],
      'ac_frequency_drive'      =>     [AcFequencyDrive::class, 'ac_fequency_drive'],
      'ac_frequency_drive2'     =>     [AcFequencyDrive::class, 'ac_fequency_drive'],
      'bearing'                 =>     [Bearing::class, 'bearing'],
      'bearing2'                =>     [Bearing::class, 'bearing'],
      'pneumatic'               =>     [Pneumatic::class, 'pneumatic'],
      'pneumatic2'              =>     [Pneumatic::class, 'pneumatic'],
